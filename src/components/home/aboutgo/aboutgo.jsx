...
const AboutGO = () => {
  return (
    <div className="flex flex-col md:flex-row items-center px-6 py-12 bg-white">
      ...
      <div className="md:w-1/2 w-full text-center md:text-left flex flex-col items-center md:items-start mb-8 md:mb-0">
      ...
      <div className="md:w-1/2 w-full px-4 text-gray-700 flex flex-col justify-center items-center md:items-start">
        <p className="text-lg sm:text-xl lg:text-4xl leading-relaxed text-center md:text-left">
          Top performers gain global recognition, with the top 25 schools featured in major publications.
          Join GIO to inspire innovation and showcase your school’s excellence.
        </p>
      </div>
    </div>
  );
