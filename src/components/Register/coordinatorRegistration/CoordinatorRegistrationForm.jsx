  ...
  return (
    <div className="flex flex-col items-center py-10 px-4 bg-gradient-to-b from-blue-200 via-white to-blue-100 min-h-screen font-poppins">
      ...
      {!isLoginMode && (
        ...
        >
          Are you a Teacher, Principal, Headmaster, or Social Worker? Join us as
          a Global Innovator Olympiad Coordinator! Fill out the form to get
          started.
        </motion.p>
      )}
        ...
        >
          ...
          {!isLoginMode && (
            <motion.div>
              <label
                htmlFor="name"
                className="block font-semibold text-xl text-gray-700"
              >
                Your Name
              </label>
              <input
          ...
          {!isLoginMode && (
            <>
              ...
              <motion.div className="flex flex-col">
                ...
                <label
                  htmlFor="whatsapp"
                  className="block font-semibold text-xl text-gray-700 mt-4"
                >
                  WhatsApp Number
                </label>
                <input
